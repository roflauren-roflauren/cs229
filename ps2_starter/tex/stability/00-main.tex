\item \points{12} {\bf Logistic Regression: Training stability}
...
\begin{enumerate}
  ...
  \input{stability/01-a-vs-b}

\ifnum\solutions=1 {
  \input{stability/01-a-vs-b-sol}
} \fi

  \input{stability/02-unstable}

\ifnum\solutions=1 {
  \input{stability/02-unstable-sol}
} \fi


  \input{stability/03-modifications}

\ifnum\solutions=1 {
  \input{stability/03-modifications-sol}
} \fi
